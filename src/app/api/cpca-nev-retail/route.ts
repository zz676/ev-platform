...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("Error fetching CPCA NEV retail:", error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await prisma.cpcaNevRetail.upsert({
      where: {
    ...
    console.error("Error creating CPCA NEV retail:", { message: errorMessage, payload: body });
