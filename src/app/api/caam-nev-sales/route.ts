...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("Error fetching CAAM NEV sales:", error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await prisma.caamNevSales.upsert({
      where: {
    ...
    console.error("Error creating CAAM NEV sales:", { message: errorMessage, payload: body });
